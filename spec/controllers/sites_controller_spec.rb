...
describe SitesController, :type => :controller do
  ...
  describe 'features' do
    it 'GETs features' do
      get :features, :domainname => 'piousbox.com', :locale => :en
    ...
    #   get :features, :features_page => 2, :domain => 'piousbox.com', :locale => :en
    #   response.should render_template( 'sites/features' )
    # end
    ...
    it 'displays partial' do
      ...
      get :show, :domainname => 'piousbox.com', :locale => :en
  ...
  describe 'show' do
    ...
    it 'GETs show, sets locale' do
      ...
      response.should render_template('sites/blog')
    ...
    it 'GETs newsitems page 2' do
      get :show, :domainname => 'piousbox.com', :newsitems_page => 2, :locale => :en
      response.should render_template( 'sites/blog' )
    end

    it 'GETs json (by-id)' do
    ...
    it 'in newsitems, renders photos that are not inside a gallery' do
      ...
      get :show, :site_id => @site.id, :locale => :en
      response.should be_success
    end
  end
  ...
  describe 'users/ link' do
    ...
    it 'links properly if the site is user-enabled' do
      get :show, :domainname => 'pi.local', :locale => :en
