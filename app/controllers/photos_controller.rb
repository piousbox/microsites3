...
class PhotosController < ApplicationController
  ...
  def j_create
    @photo = Photo.new( params[:photo].permit( :photo, :name, :descr, :is_public, :gallery ) )
  ...
  def create
    puts! params[:photo], 'photo params'
    
    @photo = Photo.new( params[:photo].permit( :photo, :name, :descr, :is_public, :gallery_id ) )
    authorize! :create, @photo
